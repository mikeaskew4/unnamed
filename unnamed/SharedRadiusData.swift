...
class SharedRadiusData: ObservableObject {
    ...
    @Published var stroke: CGFloat = 1
    @Published var divisions: Int = 1  // Use Int for divisions
    @Published var gap: CGFloat = 1
    ...
    func reset() {
        ...
        stroke = 1        // Reset stroke to initial value
        divisions = 1    // Reset divisions to initial value
        gap = 1
        rotation = 0
    }
}
